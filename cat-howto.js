...
const lessons = [
  ...
  ['fish', ['まずは、おさかな', '猫と魚が同じ空間に入ると、猫が魚まで歩いて食べ、元の場所へ戻ります。同じ切り分けで箱にも行けるときは、そのまま箱へ向かいます。魚を取ると、段ボールが開きます。'], ['A fish for your friend', 'Put the cat and fish in the same space. The cat walks over and eats the fish. It goes straight to the box if the box shares its space; otherwise it returns to its original spot. The cardboard box will open.']],
  ['cushion', ['クッションがおうち', 'スタート地点のクッションは、猫が戻る場所の目印です。紙袋で移動したあとは、魚を食べに行く直前の場所へ戻ります。'], ['A cushion to come home to', 'The cushion marks the starting spot. After using a paper bag, the cat returns to the spot it occupied just before visiting the fish.']],
