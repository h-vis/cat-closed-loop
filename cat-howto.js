...
const lessons = [
  ...
  ['fish', ['まずは、おさかな', '猫と魚が同じ空間に入ると、猫が魚まで歩いて食べ、元の場所へ戻ります。魚を取ると、段ボールが開きます。'], ['A fish for your friend', 'Put the cat and fish in the same space. The cat walks over, eats the fish, then returns to its original spot. The cardboard box will open.']],
